...
/// 状态管理
/// </summary>
public interface IStateManageBase<out TStateManage> : ITransientDependency where TStateManage : IStateManageBase<TStateManage> {
    /// <summary>
    /// 设置状态组件名称
    /// </summary>
    ...
    TStateManage Metadata( IDictionary<string, string> metadata );
    /// <summary>
    /// 移除元数据
    /// </summary>
    /// <param name="key">键</param>
    ...
    TStateManage In( string property, IEnumerable<object> values );
    /// <summary>
    /// 设置In条件
    /// </summary>
    /// <param name="property">属性名</param>
