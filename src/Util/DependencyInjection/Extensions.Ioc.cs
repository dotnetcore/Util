...
namespace Util.DependencyInjection {
    ...
    public static partial class Extensions {
        ...
        public static IRegistrationBuilder<TImplementation, SimpleActivatorData, SingleRegistrationStyle>
            AddSingleton<TService, TImplementation>( this ContainerBuilder builder, TImplementation instance ) where TService : class where TImplementation : class, TService {
