...
/// Dapr状态管理
/// </summary>
public partial class DaprStateManageBase<TStateManage> : IStateManageBase<TStateManage> where TStateManage : IStateManageBase<TStateManage> {
    ...
    public DaprStateManageBase( DaprClient client, IOptions<DaprOptions> options, ILoggerFactory loggerFactory, IKeyGenerator keyGenerator ) {
    ...
    public TStateManage Metadata( IDictionary<string, string> metadata ) {
        if ( metadata == null )
            return Return();
