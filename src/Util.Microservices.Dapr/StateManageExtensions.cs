...
public static class StateManageExtensions {
    ...
    public static TStateManage EqualIfNotEmpty<TStateManage>( this TStateManage source, string property, object value ) where TStateManage : IStateManageBase<TStateManage> {
    ...
    public static TStateManage InIf<TStateManage>( this TStateManage source, string property, IEnumerable<object> values, bool condition ) where TStateManage : IStateManageBase<TStateManage> {
        source.CheckNull( nameof( source ) );
