...
namespace Util.Security.Identity.Services.Implements {
    ...
    public class RoleManager<TRole, TKey, TParentId> : DomainServiceBase, IRoleManager<TRole, TKey, TParentId> where TRole : Role<TRole, TKey, TParentId> {
        /// <summary>
        /// 初始化角色服务
        /// </summary>
        /// <param name="roleManager">Identity角色服务</param>
        public RoleManager( RoleManager<TRole> roleManager ) {
            Manager = roleManager;
        }
