...
namespace Util.Data.EntityFrameworkCore {
    ...
    public static class OptionsExtensions {
        ...
        public static Options UsePgSqlUnitOfWork<TService, TImplementation>( this Options options, string connection, Action<DbContextOptionsBuilder> setupAction = null,
            Action<NpgsqlDbContextOptionsBuilder> pgSqlSetupAction = null,bool isEnableLegacyTimestampBehavior = false )
            where TService : class, IUnitOfWork
            where TImplementation : UnitOfWorkBase, TService {
            return options.UsePgSqlUnitOfWork<TService, TImplementation>( connection, null, setupAction, pgSqlSetupAction, isEnableLegacyTimestampBehavior );
        }
        ...
        public static Options UsePgSqlUnitOfWork<TService, TImplementation>( this Options options, DbConnection connection, Action<DbContextOptionsBuilder> setupAction = null,
            ...
            where TService : class, IUnitOfWork
            where TImplementation : UnitOfWorkBase, TService {
            return options.UsePgSqlUnitOfWork<TService, TImplementation>( null, connection, setupAction, pgSqlSetupAction, isEnableLegacyTimestampBehavior );
        }
        ...
        private static Options UsePgSqlUnitOfWork<TService, TImplementation>( this Options options, string connectionString, DbConnection connection, Action<DbContextOptionsBuilder> setupAction,
            Action<NpgsqlDbContextOptionsBuilder> pgSqlSetupAction, bool isEnableLegacyTimestampBehavior )
            where TService : class, IUnitOfWork
            where TImplementation : UnitOfWorkBase, TService {
            AppContext.SetSwitch( "Npgsql.EnableLegacyTimestampBehavior", isEnableLegacyTimestampBehavior );
            options.AddExtension( new PgSqlOptionsExtension<TService, TImplementation>( connectionString, connection, setupAction, pgSqlSetupAction ) );
            return options;
        }
    }
}
