...
namespace Util.Data.Dapper.Tests.SqlQuery {
    ...
    public partial class PostgreSqlQueryTest {
        ...
        public async Task TestExecuteQuery_1() {
            ...
            //获取对象
            var result = _sqlQuery.Select().From( "Products.Product" ).In( "ProductId", new[] { id, id2 } ).ExecuteQuery();
        ...
        public async Task TestExecuteQuery_2() {
            ...
            //获取对象
            var result = _sqlQuery.Select("ProductId As Id,Code").From( "Products.Product" ).In( "ProductId", new[] { id, id2 } ).ExecuteQuery<Product>();
        ...
        public async Task TestExecuteQuery_3() {
            ...
            var result = _sqlQuery
                ...
                .LeftJoin( "Sales.Order As o" ).On( "o.OrderId", "i.OrderId" )
        ...
        public async Task TestExecuteQueryAsync_2() {
            ...
            //获取对象
            var result = await _sqlQuery.Select( "ProductId As Id,Code" ).From( "Products.Product" ).In( "ProductId", new[] { id, id2 } ).ExecuteQueryAsync<Product>();
        ...
        public async Task TestToList_1() {
            ...
            //获取对象
            var result = _sqlQuery.Select().From( "Products.Product" ).In( "ProductId", new[] { id, id2 } ).ToList();
        ...
        public async Task TestToList_2() {
            ...
            //获取对象
            var result = _sqlQuery.Select( "ProductId As Id,Code" ).From( "Products.Product" ).In( "ProductId", new[] { id, id2 } ).ToList<Product>();
        ...
        public async Task TestToListAsync_1() {
            ...
            //获取对象
            var result = await _sqlQuery.Select().From( "Products.Product" ).In( "ProductId", new[] { id, id2 } ).ToListAsync();
        ...
        public async Task TestToListAsync_2() {
            ...
            //获取对象
            var result = await _sqlQuery.Select( "ProductId As Id,Code" ).From( "Products.Product" ).In( "ProductId", new[] { id, id2 } ).ToListAsync<Product>();
