...
public partial class EllipsisTagHelperTest {
    ...
    public void TestBindTooltip() {
            _wrapper.SetContextAttribute( AngularConst.BindTooltip, "true" );
            var result = new StringBuilder();
            result.Append( "<ellipsis [tooltip]=\"true\"></ellipsis>" );
            Assert.Equal( result.ToString(), GetResult() );
        }
    ...
    public void TestBindLength() {
            _wrapper.SetContextAttribute( AngularConst.BindLength, "2" );
            var result = new StringBuilder();
            result.Append( "<ellipsis [length]=\"2\"></ellipsis>" );
            Assert.Equal( result.ToString(), GetResult() );
        }
    ...
    /// </summary>
    [Fact]
    public void TestBindLines() {
            _wrapper.SetContextAttribute( AngularConst.BindLines, "2" );
            var result = new StringBuilder();
            result.Append( "<ellipsis [lines]=\"2\"></ellipsis>" );
            Assert.Equal( result.ToString(), GetResult() );
        }
    ...
    /// </summary>
    [Fact]
    public void TestBindFullWidthRecognition() {
            _wrapper.SetContextAttribute( AngularConst.BindFullWidthRecognition, "true" );
            var result = new StringBuilder();
            result.Append( "<ellipsis [fullWidthRecognition]=\"true\"></ellipsis>" );
            Assert.Equal( result.ToString(), GetResult() );
        }
