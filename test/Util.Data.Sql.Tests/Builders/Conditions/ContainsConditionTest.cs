    ...
    public class ContainsConditionTest {
        ...
        public void TestCreate_Validate() {
            Assert.Throws<ArgumentNullException>( () => {
                var condition = new ContainsCondition( _parameterManager, "", 1, true );
            } );
        }
        ...
        public void TestGetCondition_1() {
            var condition = new ContainsCondition( _parameterManager, "a", "b", true );
        ...
        public void TestGetCondition_2() {
            var condition = new ContainsCondition( _parameterManager, "a", "b", false );
