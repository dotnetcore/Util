    ...
    public class EqualConditionTest {
        ...
        public void TestCreate_Validate() {
            Assert.Throws<ArgumentNullException>( () => {
                var condition = new EqualCondition( _parameterManager, "", 1, true );
            } );
        }
        ...
        public void TestGetCondition_1() {
            var condition = new EqualCondition( _parameterManager, "a", 1, true );
        ...
        public void TestGetCondition_2() {
            var condition = new EqualCondition( _parameterManager, "a", "b", false );
        ...
        public void TestGetCondition_3() {
            var condition = new EqualCondition( _parameterManager, "a", null, true );
        ...
        public void TestGetCondition_4() {
            ...
            var condition = new EqualCondition( _parameterManager, "a", builder, true );
