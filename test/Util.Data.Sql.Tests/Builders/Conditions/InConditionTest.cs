    ...
    public class InConditionTest {
        ...
        public void TestCreate_Validate() {
            ...
            Assert.Throws<ArgumentNullException>( () => {
                var condition = new InCondition( _parameterManager, "", parameters, true );
            } );
        }
        ...
        public void TestGetCondition_1() {
            var parameters = new List<string> { "b" };
            var condition = new InCondition( _parameterManager, "a", parameters, true );
        ...
        public void TestGetCondition_5() {
            var parameters = new List<string> { "b" };
            var condition = new InCondition( _parameterManager, "a", parameters, false );
        ...
        public void TestGetCondition_8() {
            ...
            var condition = new InCondition( _parameterManager, "a", builder, true );
