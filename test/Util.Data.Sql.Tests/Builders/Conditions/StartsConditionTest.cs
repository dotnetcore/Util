    ...
    public class StartsConditionTest {
        ...
        public void TestCreate_Validate() {
            Assert.Throws<ArgumentNullException>( () => {
                var condition = new StartsCondition( _parameterManager, "", 1, true );
            } );
        }
        ...
        public void TestGetCondition_1() {
            var condition = new StartsCondition( _parameterManager, "a", "b", true );
        ...
        public void TestGetCondition_2() {
            var condition = new StartsCondition( _parameterManager, "a", "b", false );
