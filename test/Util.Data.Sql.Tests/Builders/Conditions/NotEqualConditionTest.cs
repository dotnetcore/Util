    ...
    public class NotEqualConditionTest {
        ...
        public void TestCreate_Validate() {
            Assert.Throws<ArgumentNullException>( () => {
                var condition = new NotEqualCondition( _parameterManager, "", 1, true );
            } );
        }
        ...
        public void TestGetCondition_1() {
            var condition = new NotEqualCondition( _parameterManager, "a", 1, true );
        ...
        public void TestGetCondition_2() {
            var condition = new NotEqualCondition( _parameterManager, "a", "b", false );
            Assert.Equal( "a<>b", GetResult( condition ) );
            Assert.Equal( 0, _parameterManager.GetParams().Count );
        }

        /// <summary>
        /// 测试获取条件 - 参数值为null,则输出 is null
        /// </summary>
        [Fact]
        public void TestGetCondition_3() {
            var condition = new NotEqualCondition( _parameterManager, "a", null, true );
        ...
        public void TestGetCondition_4() {
            ...
            var condition = new NotEqualCondition( _parameterManager, "a", builder, true );
