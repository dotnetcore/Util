    ...
    public class LessConditionTest {
        ...
        public void TestCreate_Validate() {
            Assert.Throws<ArgumentNullException>( () => {
                var condition = new LessCondition( _parameterManager, "", 1, true );
            } );
        }
        ...
        public void TestGetCondition_1() {
            var condition = new LessCondition( _parameterManager, "a", 1, true );
        ...
        public void TestGetCondition_2() {
            var condition = new LessCondition( _parameterManager, "a", "b", false );
        ...
        public void TestGetCondition_3() {
            ...
            var condition = new LessCondition( _parameterManager, "a", builder, true );
