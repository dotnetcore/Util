...
namespace Util.Tests.Helpers {
    ...
    public class LambdaTest {
        ...
        /// </summary>
        [Fact]
        public void GetGroupPredicates_1() {
            Expression<Func<Sample, bool>> expression = null;
            Assert.Empty( Lambda.GetGroupPredicates( expression ) );
        }
        ...
        /// </summary>
        [Fact]
        public void GetGroupPredicates_2() {
            Expression<Func<Sample, bool>> expression = t => t.Email == "a";
            var result = Lambda.GetGroupPredicates( expression );
            Assert.Single( result );
            Assert.Single( result[0] );
            Assert.Equal( "(t.Email == \"a\")", result[0][0].ToString() );
        }

        /// <summary>
        /// 获取分组的谓词表达式 - Or连接的两个条件
        /// </summary>
        [Fact]
        public void GetGroupPredicates_3() {
            Expression<Func<Sample, bool>> expression = t => t.Email == "a" || t.Email == "b";
            var result = Lambda.GetGroupPredicates( expression );
            Assert.Equal( 2, result.Count );
            Assert.Single( result[0] );
            Assert.Single( result[1] );
            Assert.Equal( "(t.Email == \"a\")", result[0][0].ToString() );
            Assert.Equal( "(t.Email == \"b\")", result[1][0].ToString() );
        }

        /// <summary>
        /// 获取分组的谓词表达式 - And连接的两个条件
        /// </summary>
        [Fact]
        public void GetGroupPredicates_4() {
            Expression<Func<Sample, bool>> expression = t => t.Email == "a" && t.Email == "b";
            var result = Lambda.GetGroupPredicates( expression );
            Assert.Single( result );
            Assert.Equal( 2, result[0].Count );
            Assert.Equal( "(t.Email == \"a\")", result[0][0].ToString() );
            Assert.Equal( "(t.Email == \"b\")", result[0][1].ToString() );
        }

        /// <summary>
        /// 获取分组的谓词表达式 - Or连接 - 左侧包含两个条件
        /// </summary>
        [Fact]
        public void GetGroupPredicates_5() {
            Expression<Func<Sample, bool>> expression = t => t.Email == "a" && t.Url == "b" || t.Email == "c";
            var result = Lambda.GetGroupPredicates( expression );
            Assert.Equal( 2, result.Count );
            Assert.Equal( 2, result[0].Count );
            Assert.Single( result[1] );
            Assert.Equal( "(t.Email == \"a\")", result[0][0].ToString() );
            Assert.Equal( "(t.Url == \"b\")", result[0][1].ToString() );
            Assert.Equal( "(t.Email == \"c\")", result[1][0].ToString() );
        }

        /// <summary>
        /// 获取分组的谓词表达式 - Or连接 - 右侧包含两个条件
        /// </summary>
        [Fact]
        public void GetGroupPredicates_6() {
            Expression<Func<Sample, bool>> expression = t => t.Email == "a" || t.Email == "b" && t.Url == "c";
            var result = Lambda.GetGroupPredicates( expression );
            Assert.Equal( 2, result.Count );
            Assert.Single( result[0] );
            ...
            Assert.Equal( "(t.Email == \"a\")", result[0][0].ToString() );
            Assert.Equal( "(t.Email == \"b\")", result[1][0].ToString() );
            Assert.Equal( "(t.Url == \"c\")", result[1][1].ToString() );
        }

        /// <summary>
        /// 获取分组的谓词表达式 - Or连接 - 两侧各包含两个条件
        /// </summary>
        [Fact]
        public void GetGroupPredicates_7() {
            Expression<Func<Sample, bool>> expression = t => t.Email == "a" && t.Url == "b" || t.Email == "c" && t.Url == "d";
            var result = Lambda.GetGroupPredicates( expression );
            Assert.Equal( 2, result.Count );
            Assert.Equal( 2, result[0].Count );
            Assert.Equal( 2, result[1].Count );
            ...
            Assert.Equal( "(t.Url == \"b\")", result[0][1].ToString() );
            Assert.Equal( "(t.Email == \"c\")", result[1][0].ToString() );
            Assert.Equal( "(t.Url == \"d\")", result[1][1].ToString() );
        }
        ...
        /// </summary>
        [Fact]
        public void GetGroupPredicates_8() {
            Expression<Func<Sample, bool>> expression = t => t.Email == "a" && t.Url == "b" && t.StringValue == "c" ||
                                                             t.Email == "a2" && t.Url == "b2" && t.StringValue == "c2" ||
                                                             t.Email == "a3" && t.Url == "b3" && t.StringValue == "c3" && t.Test2.StringValue == "d" ||
                                                             t.Email == "a4" && t.Url == "b4" && t.StringValue == "c4" && t.Test2.StringValue == "d2";
            var result = Lambda.GetGroupPredicates( expression );
            ...
            Assert.Equal( "(t.Email == \"a\")", result[0][0].ToString() );
            Assert.Equal( "(t.Url == \"b\")", result[0][1].ToString() );
            Assert.Equal( "(t.StringValue == \"c\")", result[0][2].ToString() );

            Assert.Equal( "(t.Email == \"a2\")", result[1][0].ToString() );
            Assert.Equal( "(t.Url == \"b2\")", result[1][1].ToString() );
            Assert.Equal( "(t.StringValue == \"c2\")", result[1][2].ToString() );

            Assert.Equal( "(t.Email == \"a3\")", result[2][0].ToString() );
            Assert.Equal( "(t.Url == \"b3\")", result[2][1].ToString() );
            Assert.Equal( "(t.StringValue == \"c3\")", result[2][2].ToString() );
            Assert.Equal( "(t.Test2.StringValue == \"d\")", result[2][3].ToString() );

            Assert.Equal( "(t.Email == \"a4\")", result[3][0].ToString() );
            Assert.Equal( "(t.Url == \"b4\")", result[3][1].ToString() );
            Assert.Equal( "(t.StringValue == \"c4\")", result[3][2].ToString() );
