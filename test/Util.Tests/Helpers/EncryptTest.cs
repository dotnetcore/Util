...
namespace Util.Tests.Helpers {
    ...
    public class EncryptTest {
        ...
        [InlineData( "", "", "" )]
        [InlineData( "1", "", "" )]
        public void TestRsa_Validate( string input, string key, string result ) {
            Assert.Equal( result, Encrypt.AesEncrypt( input, key, Encoding.UTF8 ) );
            Assert.Equal( result, Encrypt.AesDecrypt( input, key, Encoding.UTF8 ) );
        }
        ...
        public void TestRsa() {
            ...
            var encode = Encrypt.Rsa( value, key );
            _output.WriteLine( encode );
        ...
        public void TestRsa2() {
            ...
            var encode = Encrypt.Rsa2( value,key );
            _output.WriteLine( encode );
            Assert.Equal( result, encode );
        }
    }
