...
public partial class StateManageTest {
    ...
    public async Task TestGetByIdAsync() {
        ...
        //获取数据并验证
        var result = await _stateManage.GetByIdAsync<CustomerDto2>( dto.Id );
    ...
    public async Task TestGetAllAsync() {
        ...
        //获取数据并验证
        var result = await _stateManage.GetAllAsync<CustomerDto2>();
    ...
    public async Task TestQueryAsync_1() {
        ...
        //获取数据并验证
        var result = await _stateManage.Equal( "code", code ).QueryAsync<CustomerDto2>();
    ...
    public async Task TestQueryAsync_2() {
        ...
        //获取数据并验证
        var result = await _stateManage.Equal<CustomerDto2>( t => t.Code, code ).QueryAsync<CustomerDto2>();
        Assert.Single( result );
        Assert.Contains( result, t => t.Code == code );
    }
    ...
    public async Task TestQueryAsync_3() {
        ...
        //获取数据并验证
        var result = await _stateManage.In( "code", code, code2 ).QueryAsync<CustomerDto2>();
    ...
    public async Task TestQueryAsync_4() {
        ...
        //获取数据并验证
        var result = await _stateManage.In<CustomerDto2>( t => t.Code, code, code2 ).QueryAsync<CustomerDto2>();
        Assert.Equal( 2, result.Count );
        Assert.Contains( result, t => t.Code == code );
        Assert.Contains( result, t => t.Code == code2 );
    }
    ...
    public async Task TestQueryAsync_OrderBy() {
        ...
        //获取数据并验证
        var result = await _stateManage.OrderBy<CustomerDto2>( t => t.Name ).Equal( "code", code ).QueryAsync<CustomerDto2>();
    ...
    public async Task TestQueryAsync_OrderByDescending() {
        ...
        //获取数据并验证
        var result = await _stateManage.OrderByDescending<CustomerDto2>( t => t.Name ).Equal( "code", code ).QueryAsync<CustomerDto2>();
    ...
    public async Task TestPageQueryAsync() {
        ...
        //添加数据
        await _stateManage.SaveAsync( new[] {
        ...
        var result = await _stateManage.Equal( "code", code ).PageQueryAsync<CustomerDto2>( query );
        ...
        result = await _stateManage.Equal( "code", code ).PageQueryAsync<CustomerDto2>( query );
        Assert.Equal( 2, result.Data.Count );
