...
//            var list = new List<TestTreeNode> { GetNode1() };
//            var result = new TreeTableResult<TestTreeNode>( list ).GetResult();
...
//            var list = new List<TestTreeNode> { GetNode1(), GetNode2() };
//            var result = new TreeTableResult<TestTreeNode>( list ).GetResult();
//            Assert.Single( result );
...
//            var list = new List<TestTreeNode> { GetNode1(), GetNode2(), GetNode3() };
//            var result = new TreeTableResult<TestTreeNode>( list ).GetResult();
...
//            var list = new List<TestTreeNode> { GetNode1(), GetNode2(), GetNode3(), GetNode4() };
//            var result = new TreeTableResult<TestTreeNode>( list ).GetResult();
//            Assert.Equal( 2, result.Count );
...
//            var list = new List<TestTreeNode> { GetNode1(), GetNode2(), GetNode3(), GetNode4(), GetNode5() };
//            var result = new TreeTableResult<TestTreeNode>( list ).GetResult();
//            Assert.Equal( 2, result.Count );
...
//    /// 测试树形节点
//    /// </summary>
//    public class TestTreeNode : TreeDto<TestTreeNode> {
//    }
//}
