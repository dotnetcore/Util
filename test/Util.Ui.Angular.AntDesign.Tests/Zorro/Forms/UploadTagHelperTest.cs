...
namespace Util.Ui.Angular.AntDesign.Tests.Zorro.Forms {
    ...
    public class UploadTagHelperTest {
        ...
        public void TestHeaders() {
            ...
            var result = new String();
            result.Append( "<x-upload [headers]=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestNgModel() {
            ...
            var result = new String();
            result.Append( "<x-upload [(model)]=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestWithCredentials() {
            ...
            var result = new String();
            result.Append( "<x-upload [withCredentials]=\"true\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestDisabled() {
            ...
            var result = new String();
            result.Append( "<x-upload [disabled]=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestRequired() {
            ...
            var result = new String();
            result.Append( "<x-upload [required]=\"true\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestRequiredMessage() {
            ...
            var result = new String();
            result.Append( "<x-upload requiredMessage=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestShowButton() {
            ...
            var result = new String();
            result.Append( "<x-upload [showButton]=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestShowUploadList() {
            ...
            var result = new String();
            result.Append( "<x-upload [showUploadList]=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestListType() {
            ...
            var result = new String();
            result.Append( "<x-upload listType=\"text\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestMultiple() {
            ...
            var result = new String();
            result.Append( "<x-upload [multiple]=\"true\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestButtonText() {
            ...
            var result = new String();
            result.Append( "<x-upload buttonText=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestButtonIcon() {
            ...
            var result = new String();
            result.Append( "<x-upload buttonIcon=\"check\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestAccept() {
            ...
            var result = new String();
            result.Append( "<x-upload accept=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestAcceptImage() {
            ...
            var result = new String();
            result.Append( "<x-upload accept=\".jpg,.jpeg,.png,.gif,.bmp\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestAcceptDocument() {
            ...
            var result = new String();
            result.Append( "<x-upload accept=\".xls,.xlsx,.doc,.docx,.pdf,.txt\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestImageTypes_Jpg_Png() {
            ...
            var result = new String();
            result.Append( "<x-upload accept=\".jpg,.jpeg,.png\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestDocumentTypes_Doc() {
            ...
            var result = new String();
            result.Append( "<x-upload accept=\".doc,.docx\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestSize() {
            ...
            var result = new String();
            result.Append( "<x-upload [size]=\"1.1\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestDirectory() {
            ...
            var result = new String();
            result.Append( "<x-upload [directory]=\"true\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestFilter() {
            ...
            var result = new String();
            result.Append( "<x-upload [customFilters]=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestTotalLimit() {
            ...
            var result = new String();
            result.Append( "<x-upload [totalLimit]=\"2\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestLimit() {
            ...
            var result = new String();
            result.Append( "<x-upload [limit]=\"2\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestBeforeUpload() {
            ...
            var result = new String();
            result.Append( "<x-upload [beforeUpload]=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestPreview() {
            ...
            var result = new String();
            result.Append( "<x-upload [preview]=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestRemove() {
            ...
            var result = new String();
            result.Append( "<x-upload [remove]=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestCustomRequest() {
            ...
            var result = new String();
            result.Append( "<x-upload [customRequest]=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
        ...
        public void TestOnChange() {
            ...
            var result = new String();
            result.Append( "<x-upload (modelChange)=\"a\">" );
            result.Append( "</x-upload>" );
            Assert.Equal( result.ToString(), GetResult( attributes ) );
        }
    }
