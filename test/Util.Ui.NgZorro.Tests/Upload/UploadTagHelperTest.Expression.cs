...
namespace Util.Ui.NgZorro.Tests.Upload {
    ...
    public partial class UploadTagHelperTest {
        ...
        public void TestFor_1() {
            ...
            result.Append( "<nz-upload #u_id=\"xUploadExtend\" (nzChange)=\"u_id.handleChange($event)\" x-upload-extend=\"\" [(model)]=\"model.code\" [(nzFileList)]=\"u_id.files\" [nzFilter]=\"u_id.filters\">" );
