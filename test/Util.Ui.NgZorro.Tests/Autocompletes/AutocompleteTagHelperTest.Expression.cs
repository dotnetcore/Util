...
namespace Util.Ui.NgZorro.Tests.Autocompletes {
    ...
    public partial class AutocompleteTagHelperTest {
        ...
        public void TestFor_Bool() {
            ...
            result.Append( "<nz-auto-option *ngFor=\"let item of x_enabled.options\" [nzDisabled]=\"item.disabled\" [nzLabel]=\"item.text\" [nzValue]=\"item.value\">" );
        ...
        public void TestFor_Bool_I18n() {
            ...
            result.Append( "<ng-container *ngIf=\"!x_enabled.isGroup\">" );
            result.Append( "<nz-auto-option *ngFor=\"let item of x_enabled.options\" [nzDisabled]=\"item.disabled\" [nzLabel]=\"item.text|i18n\" [nzValue]=\"item.value\">" );
