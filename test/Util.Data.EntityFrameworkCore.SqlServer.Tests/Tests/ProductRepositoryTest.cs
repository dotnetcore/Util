...
namespace Util.Data.EntityFrameworkCore.Tests {
    ...
    public partial class ProductRepositoryTest : TestBase {
        ...
        /// 测试初始化
        /// </summary>
        public ProductRepositoryTest( ITestOutputHelperAccessor accessor, IProductRepository repository,ISqlServerUnitOfWork unitOfWork ) :base(unitOfWork) {
        ...
        public void TestModificationAudit() {
            //工作单元
            var unitOfWork = (SqlServerUnitOfWork)UnitOfWork;
