...
namespace Util.Templates.Razor.Tests {
    ...
    public partial class RazorTemplateEngineTest {
        ...
        public void TestRenderByPath() {
            ...
            var path = Platform.GetPhysicalPath( "Samples/Templates/TestTemplate.cshtml" );
        ...
        public void TestRenderByPath_2() {
            ...
            var path = Platform.GetPhysicalPath( "Samples/Templates/TestTemplate2.cshtml" );
            var result = _templateEngine.RenderByPath( path, model );
        ...
        public void TestSaveByPath() {
            var filePath = Platform.GetPhysicalPath( "result/SaveByPath.txt" );
            Util.Helpers.File.Delete( filePath );
            var model = new TestModel { Name = "util" };
            var templatePath = Platform.GetPhysicalPath( "Samples/Templates/TestTemplate.cshtml" );
        ...
        public async Task TestSaveByPathAsync() {
            var filePath = Platform.GetPhysicalPath( "result/SaveByPathAsync.txt" );
            Util.Helpers.File.Delete( filePath );
            var model = new TestModel { Name = "util" };
            var templatePath = Platform.GetPhysicalPath( "Samples/Templates/TestTemplate.cshtml" );
