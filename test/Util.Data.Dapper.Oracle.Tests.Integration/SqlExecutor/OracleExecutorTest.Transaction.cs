    ...
    public partial class OracleExecutorTest {
        ...
        public async Task TestTransaction_1() {
            ...
            try {
                ...
                //Code2列名错误,插入Id2失败
                await _sqlExecutor
                    .Insert( "ProductId,Code,Code2", "Product" )
            ...
            //断言
            var exists = await _sqlExecutor.From( "Product" ).Where( "ProductId", id ).ExecuteExistsAsync();
            var exists2 = await _sqlExecutor.From( "Product" ).Where( "ProductId", id2 ).ExecuteExistsAsync();
            Assert.True( exists );
        ...
        /// </summary>
        [Fact]
        public async Task TestTransaction_6() {
            //开始事务
            _sqlExecutor.BeginTransaction();
