...
namespace Util.Data.EntityFrameworkCore.Tests {
    ...
    public class CustomerRepositoryTest : TestBase {
        ...
        /// 测试初始化
        /// </summary>
        public CustomerRepositoryTest( ICustomerRepository repository, IPgSqlUnitOfWork unitOfWork ) : base( unitOfWork ) {
        ...
        private List<Customer> AddCustomers( int count = 2, string name = null ) {
            ...
            return customers.OrderBy( t => t.Id ).ToList();
        }
        ...
        public void TestToPageList_1() {
            ...
            //创建查询参数
            var parameter = new QueryParameter { PageSize = 3, Page = 1, Order = "Id" };
        ...
        public void TestToPageList_2() {
            ...
            //创建查询参数
            var parameter = new QueryParameter { PageSize = 3, Page = 2, Order = "Id" };
        ...
        public void TestToPageList_3() {
            ...
            //查询
            var result = _repository.Find().Where( t => t.Name == name ).OrderBy( t => t.Id ).ToPageList( parameter );
