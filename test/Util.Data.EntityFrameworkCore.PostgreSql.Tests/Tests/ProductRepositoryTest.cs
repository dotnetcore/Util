...
namespace Util.Data.EntityFrameworkCore.Tests {
    ...
    public partial class ProductRepositoryTest : TestBase {
        ...
        /// 测试初始化
        /// </summary>
        public ProductRepositoryTest( ITestOutputHelperAccessor testOutputHelperAccessor,
            IProductRepository repository, IPgSqlUnitOfWork unitOfWork ) : base(unitOfWork){
        ...
        /// 添加产品
        /// </summary>
        private Product AddProduct( string name = null ) {
        ...
        private List<Product> AddProducts( int count = 2, string name = null ) {
            ...
            return products.OrderBy( t => t.Code ).ToList();
        }
        ...
        /// </summary>
        [Fact]
        public void TestFindById_Tracking_1() {
            //添加实体
        ...
        /// </summary>
        [Fact]
        public void TestFindById_Tracking_2() {
            //添加实体
            var entity = AddProduct();
            UnitOfWork.ClearCache();
        ...
        /// </summary>
        [Fact]
        public void TestFindById_NoTracking() {
            //添加实体
            var entity = AddProduct();
            UnitOfWork.ClearCache();
        ...
        public void TestUpdate_1() {
            ...
            //查找实体并修改
            var product = _repository.FindById( entity.Id );
            product.Code = code;
        ...
        /// </summary>
        [Fact]
        public void TestUpdate_1_Concurrency() {
            //常量
            ...
            var product2 = _repository.FindById( entity.Id );
        ...
        /// </summary>
        [Fact]
        public void TestUpdate_2_InvalidOperation() {
            //常量
            ...
            //模拟更新之前无意中已查找出该实体
            _repository.FindById( entity.Id );
        ...
        /// </summary>
        [Fact]
        public void TestUpdate_2_Concurrency() {
            //常量
        ...
        /// </summary>
        [Fact]
        public void TestUpdate_3_Concurrency_1() {
            //常量
        ...
        /// </summary>
        [Fact]
        public void TestUpdate_3_Concurrency_2() {
            //常量
        ...
        public void TestUpdate_4() {
            ...
            var products = _repository.FindByIds( entities.Select( t => t.Id ) ).ToList();
            ...
            //验证
            var result = _repository.FindByIds( entities.Select( t => t.Id ) ).ToList();
        ...
        /// <summary>
        /// 测试Util Update更新方法 - 异步
        /// </summary>
        [Fact]
        public async Task TestUpdateAsync_1() {
            //常量
            var code = "TestUpdateAsync_1_Code";
        ...
        public async Task TestUpdateAsync_2() {
            //常量
            var count = 3;
            var code = "TestUpdateAsync_2_Code";
            ...
            //查找实体,赋值,调用UpdateAsync方法,提交工作单元
            var products = ( await _repository.FindByIdsAsync( entities.Select( t => t.Id ) ) ).ToList();
            products.ForEach( product => product.Code = code );
            ...
            //验证
            var result = ( await _repository.FindByIdsAsync( entities.Select( t => t.Id ) ) ).ToList();
            Assert.Equal( code, result[0].Code );
            Assert.Equal( code, result[1].Code );
            Assert.Equal( code, result[2].Code );
        }
        ...
        /// </summary>
        [Fact]
        public void TestRemove_Entities_1() {
            //常量
            var count = 3;
            ...
            //验证
            using( _repository.DisableDeleteFilter() ) {
                var result = _repository.FindByIds( ids );
        ...
        /// </summary>
        [Fact]
        public void TestRemove_Entities_2() {
            //常量
            var count = 3;
            ...
            //验证
            using( _repository.DisableDeleteFilter() ) {
                var result = _repository.FindByIds( products.Select( t => t.Id ) );
                Assert.Equal( count, result.Count );
                result.ForEach( t => Assert.True( t.IsDeleted ) );
            }
        }
        ...
        /// </summary>
        [Fact]
        public void TestModificationAudit() {
            //工作单元
            var unitOfWork = (PgSqlUnitOfWork)UnitOfWork;
        ...
        /// </summary>
        [Fact]
        public void TestExtraProperties_1() {
            //常量
        ...
        /// </summary>
        [Fact]
        public void TestExtraProperties_2() {
            //常量
            ...
            //验证
            var oldEntity = _repository.FindById( entity.Id );
        ...
        /// </summary>
        [Fact]
        public void TestExtraProperties_3() {
            //常量
            var code = 2;
        ...
        /// </summary>
        [Fact]
        public void TestExtraProperties_4() {
            //常量
            var code = 2;
        ...
        /// </summary>
        [Fact]
        public void TestExtraProperties_5() {
            //常量
            var code = 1;
        ...
        /// </summary>
        [Fact]
        public void TestExtraProperties_6() {
            //常量
            var code = 1;
        ...
        /// </summary>
        [Fact]
        public void TestExtraProperties_7() {
            //常量
            var code = 2;
        ...
        /// </summary>
        [Fact]
        public void TestExtraProperties_8() {
            //常量
            var code = 2;
        ...
        /// </summary>
        [Fact]
        public void TestExtraProperties_9() {
            //常量
        ...
        /// </summary>
        [Fact]
        public void TestExtraProperties_10() {
            //常量
        ...
        /// </summary>
        [Fact]
        public void TestExtraProperties_11() {
            //常量
            var code = 2;
        ...
        /// </summary>
        [Fact]
        public void TestExtraProperties_12() {
            //常量
            var code = 2;
