...
namespace Util.Samples.Apis.Viser {
    ...
    public class LineController : WebApiControllerBase {
        ...
        public IActionResult GetBasicLine() {
            ...
            //data.Add( "1991", new Point( "值", 3 ) );
            //data.Add( "1992", new Point( "值", 4 ) );
            //data.Add( "1993", new Point( "值", 3.5 ) );
            //data.Add( "1994", new Point( "值", 5 ) );
            //data.Add( "1995", new Point( "值", 4.9 ) );
            //data.Add( "1996", new Point( "值", 6 ) );
            //data.Add( "1997", new Point( "值", 7 ) );
            //data.Add( "1998", new Point( "值", 9 ) );
            //data.Add( "1999", new Point( "值", 13 ) );
